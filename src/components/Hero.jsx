    ...
    <div className="overflow-hidden bg-gray-900 py-20 sm:py-32 lg:pb-32 xl:pb-36">
      <Container>
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          ...
          <h1 className="bg-gray-900 p-1 font-extrabold text-transparent text-5xl bg-clip-text bg-gradient-to-r from-cyan-500 to-blue-800 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800">Split payments between<span id="spin" className="text-5xl bg-clip-text bg-gradient-to-r from-cyan-500 to-blue-800 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 text-transparent bg-clip-text bg-gradient-to-br from-indigo-400 to-blue-500"></span><br/></h1>
            <p className="bg-gray-900 mt-6 text-lg text-gray-00">
              Join now to get started creating virtual cards to combine payments.
            </p>
            <div className="bg-gray-900 mt-8 flex flex-wrap gap-x-6 gap-y-4">
              <AppStoreLink />
              <Button
