...
export function SecondaryFeatures() {
  return (
    <section
      ...
      className="py-5 sm:py-20 bg-gray-900"
    >
      <Container>
        ...
        <ul
          role="list"
          className="mx-auto mt-5 grid max-w-2xl grid-cols-1 gap-6 text-sm sm:mt-20 sm:grid-cols-2 md:gap-y-10 lg:max-w-none lg:grid-cols-3"
        >
